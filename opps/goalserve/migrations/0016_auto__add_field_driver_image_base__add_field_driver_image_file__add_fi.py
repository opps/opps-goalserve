...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Driver.image_base'
        db.add_column(u'goalserve_driver', 'image_base',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Driver.image_file'
        db.add_column(u'goalserve_driver', 'image_file',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['images.Image'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'F1Team.image_base'
        db.add_column(u'goalserve_f1team', 'image_base',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'F1Team.image_file'
        db.add_column(u'goalserve_f1team', 'image_file',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['images.Image'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Driver.image_base'
        db.delete_column(u'goalserve_driver', 'image_base')

        # Deleting field 'Driver.image_file'
        db.delete_column(u'goalserve_driver', 'image_file_id')

        # Deleting field 'F1Team.image_base'
        db.delete_column(u'goalserve_f1team', 'image_base')

        # Deleting field 'F1Team.image_file'
        db.delete_column(u'goalserve_f1team', 'image_file_id')
