...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.stadium_name'
        db.add_column(u'goalserve_match', 'stadium_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Match.stadium_name'
        db.delete_column(u'goalserve_match', 'stadium_name')
