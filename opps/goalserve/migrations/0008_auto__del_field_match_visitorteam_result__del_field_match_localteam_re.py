...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Match.localteam_goals'
        db.add_column(u'goalserve_match', 'localteam_goals',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Match.visitorteam_goals'
        db.add_column(u'goalserve_match', 'visitorteam_goals',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Match.localteam_goals'
        db.delete_column(u'goalserve_match', 'localteam_goals')

        # Deleting field 'Match.visitorteam_goals'
        db.delete_column(u'goalserve_match', 'visitorteam_goals')
