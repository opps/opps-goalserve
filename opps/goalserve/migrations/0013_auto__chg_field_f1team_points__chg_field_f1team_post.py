...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'F1Team.points'
        db.alter_column(u'goalserve_f1team', 'points', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'F1Team.post'
        db.alter_column(u'goalserve_f1team', 'post', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'F1Team.points'
        db.alter_column(u'goalserve_f1team', 'points', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'F1Team.post'
        db.alter_column(u'goalserve_f1team', 'post', self.gf('django.db.models.fields.IntegerField')(default=None))
