...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.image_file'
        db.add_column(u'goalserve_player', 'image_file',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['images.Image'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'Team.image_file'
        db.add_column(u'goalserve_team', 'image_file',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['images.Image'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'Stadium.image_file'
        db.add_column(u'goalserve_stadium', 'image_file',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['images.Image'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Player.image_file'
        db.delete_column(u'goalserve_player', 'image_file_id')

        # Deleting field 'Team.image_file'
        db.delete_column(u'goalserve_team', 'image_file_id')

        # Deleting field 'Stadium.image_file'
        db.delete_column(u'goalserve_stadium', 'image_file_id')
