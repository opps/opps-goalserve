...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.extra'
        db.add_column(u'goalserve_match', 'extra',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Match.week_number'
        db.add_column(u'goalserve_match', 'week_number',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'F1Results.extra'
        db.add_column(u'goalserve_f1results', 'extra',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'F1Commentary.extra'
        db.add_column(u'goalserve_f1commentary', 'extra',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Stadium.extra'
        db.add_column(u'goalserve_stadium', 'extra',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MatchCommentary.extra'
        db.add_column(u'goalserve_matchcommentary', 'extra',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MatchStandings.extra'
        db.add_column(u'goalserve_matchstandings', 'extra',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MatchEvent.extra'
        db.add_column(u'goalserve_matchevent', 'extra',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Driver.extra'
        db.add_column(u'goalserve_driver', 'extra',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.extra'
        db.add_column(u'goalserve_category', 'extra',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Country.extra'
        db.add_column(u'goalserve_country', 'extra',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'F1Team.extra'
        db.add_column(u'goalserve_f1team', 'extra',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Player.extra'
        db.add_column(u'goalserve_player', 'extra',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'F1Race.extra'
        db.add_column(u'goalserve_f1race', 'extra',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Team.extra'
        db.add_column(u'goalserve_team', 'extra',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'F1Tournament.extra'
        db.add_column(u'goalserve_f1tournament', 'extra',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Match.extra'
        db.delete_column(u'goalserve_match', 'extra')

        # Deleting field 'Match.week_number'
        db.delete_column(u'goalserve_match', 'week_number')

        # Deleting field 'F1Results.extra'
        db.delete_column(u'goalserve_f1results', 'extra')

        # Deleting field 'F1Commentary.extra'
        db.delete_column(u'goalserve_f1commentary', 'extra')

        # Deleting field 'Stadium.extra'
        db.delete_column(u'goalserve_stadium', 'extra')

        # Deleting field 'MatchCommentary.extra'
        db.delete_column(u'goalserve_matchcommentary', 'extra')

        # Deleting field 'MatchStandings.extra'
        db.delete_column(u'goalserve_matchstandings', 'extra')

        # Deleting field 'MatchEvent.extra'
        db.delete_column(u'goalserve_matchevent', 'extra')

        # Deleting field 'Driver.extra'
        db.delete_column(u'goalserve_driver', 'extra')

        # Deleting field 'Category.extra'
        db.delete_column(u'goalserve_category', 'extra')

        # Deleting field 'Country.extra'
        db.delete_column(u'goalserve_country', 'extra')

        # Deleting field 'F1Team.extra'
        db.delete_column(u'goalserve_f1team', 'extra')

        # Deleting field 'Player.extra'
        db.delete_column(u'goalserve_player', 'extra')

        # Deleting field 'F1Race.extra'
        db.delete_column(u'goalserve_f1race', 'extra')

        # Deleting field 'Team.extra'
        db.delete_column(u'goalserve_team', 'extra')

        # Deleting field 'F1Tournament.extra'
        db.delete_column(u'goalserve_f1tournament', 'extra')
