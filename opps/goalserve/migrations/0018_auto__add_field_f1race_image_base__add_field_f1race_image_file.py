...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'F1Race.image_base'
        db.add_column(u'goalserve_f1race', 'image_base',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'F1Race.image_file'
        db.add_column(u'goalserve_f1race', 'image_file',
    ...
    def backwards(self, orm):
        # Deleting field 'F1Race.image_base'
        db.delete_column(u'goalserve_f1race', 'image_base')

        # Deleting field 'F1Race.image_file'
        db.delete_column(u'goalserve_f1race', 'image_file_id')
