...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MatchStandings.overall_gp'
        db.add_column(u'goalserve_matchstandings', 'overall_gp',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MatchStandings.overall_gs'
        db.add_column(u'goalserve_matchstandings', 'overall_gs',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MatchStandings.overall_ga'
        db.add_column(u'goalserve_matchstandings', 'overall_ga',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MatchStandings.overall_w'
        db.add_column(u'goalserve_matchstandings', 'overall_w',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MatchStandings.overall_l'
        db.add_column(u'goalserve_matchstandings', 'overall_l',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MatchStandings.overall_gp'
        db.delete_column(u'goalserve_matchstandings', 'overall_gp')

        # Deleting field 'MatchStandings.overall_gs'
        db.delete_column(u'goalserve_matchstandings', 'overall_gs')

        # Deleting field 'MatchStandings.overall_ga'
        db.delete_column(u'goalserve_matchstandings', 'overall_ga')

        # Deleting field 'MatchStandings.overall_w'
        db.delete_column(u'goalserve_matchstandings', 'overall_w')

        # Deleting field 'MatchStandings.overall_l'
        db.delete_column(u'goalserve_matchstandings', 'overall_l')
