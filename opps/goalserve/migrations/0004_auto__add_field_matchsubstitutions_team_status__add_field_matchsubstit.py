...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MatchSubstitutions.team_status'
        db.add_column(u'goalserve_matchsubstitutions', 'team_status',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MatchSubstitutions.team'
        db.add_column(u'goalserve_matchsubstitutions', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['goalserve.Team'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)


        # Changing field 'MatchStats.possesiontime'
        db.alter_column(u'goalserve_matchstats', 'possesiontime', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting field 'MatchSubstitutions.team_status'
        db.delete_column(u'goalserve_matchsubstitutions', 'team_status')

        # Deleting field 'MatchSubstitutions.team'
        db.delete_column(u'goalserve_matchsubstitutions', 'team_id')


        # Changing field 'MatchStats.possesiontime'
        db.alter_column(u'goalserve_matchstats', 'possesiontime', self.gf('django.db.models.fields.IntegerField')(null=True))
