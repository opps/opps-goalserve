...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'F1Tournament.g_driver_id'
        db.add_column(u'goalserve_f1tournament', 'g_driver_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'F1Tournament.g_team_id'
        db.add_column(u'goalserve_f1tournament', 'g_team_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'Match.g_driver_id'
        db.add_column(u'goalserve_match', 'g_driver_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'Match.g_team_id'
        db.add_column(u'goalserve_match', 'g_team_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'F1Commentary.g_driver_id'
        db.add_column(u'goalserve_f1commentary', 'g_driver_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'F1Commentary.g_team_id'
        db.add_column(u'goalserve_f1commentary', 'g_team_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'F1Results.g_driver_id'
        db.add_column(u'goalserve_f1results', 'g_driver_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'F1Results.g_team_id'
        db.add_column(u'goalserve_f1results', 'g_team_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'MatchCommentary.g_driver_id'
        db.add_column(u'goalserve_matchcommentary', 'g_driver_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'MatchCommentary.g_team_id'
        db.add_column(u'goalserve_matchcommentary', 'g_team_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'Category.g_driver_id'
        db.add_column(u'goalserve_category', 'g_driver_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'Category.g_team_id'
        db.add_column(u'goalserve_category', 'g_team_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'MatchEvent.g_driver_id'
        db.add_column(u'goalserve_matchevent', 'g_driver_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'MatchEvent.g_team_id'
        db.add_column(u'goalserve_matchevent', 'g_team_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'Driver.g_driver_id'
        db.add_column(u'goalserve_driver', 'g_driver_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'Driver.g_team_id'
        db.add_column(u'goalserve_driver', 'g_team_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'MatchStandings.g_driver_id'
        db.add_column(u'goalserve_matchstandings', 'g_driver_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'MatchStandings.g_team_id'
        db.add_column(u'goalserve_matchstandings', 'g_team_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'F1Race.g_driver_id'
        db.add_column(u'goalserve_f1race', 'g_driver_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'F1Race.g_team_id'
        db.add_column(u'goalserve_f1race', 'g_team_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'Country.g_driver_id'
        db.add_column(u'goalserve_country', 'g_driver_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'Country.g_team_id'
        db.add_column(u'goalserve_country', 'g_team_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'F1Team.g_driver_id'
        db.add_column(u'goalserve_f1team', 'g_driver_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'F1Team.g_team_id'
        db.add_column(u'goalserve_f1team', 'g_team_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'Player.g_driver_id'
        db.add_column(u'goalserve_player', 'g_driver_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'Player.g_team_id'
        db.add_column(u'goalserve_player', 'g_team_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'Team.g_driver_id'
        db.add_column(u'goalserve_team', 'g_driver_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'Team.g_team_id'
        db.add_column(u'goalserve_team', 'g_team_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'Stadium.g_driver_id'
        db.add_column(u'goalserve_stadium', 'g_driver_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'Stadium.g_team_id'
        db.add_column(u'goalserve_stadium', 'g_team_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'F1Tournament.g_driver_id'
        db.delete_column(u'goalserve_f1tournament', 'g_driver_id')

        # Deleting field 'F1Tournament.g_team_id'
        db.delete_column(u'goalserve_f1tournament', 'g_team_id')

        # Deleting field 'Match.g_driver_id'
        db.delete_column(u'goalserve_match', 'g_driver_id')

        # Deleting field 'Match.g_team_id'
        db.delete_column(u'goalserve_match', 'g_team_id')

        # Deleting field 'F1Commentary.g_driver_id'
        db.delete_column(u'goalserve_f1commentary', 'g_driver_id')

        # Deleting field 'F1Commentary.g_team_id'
        db.delete_column(u'goalserve_f1commentary', 'g_team_id')

        # Deleting field 'F1Results.g_driver_id'
        db.delete_column(u'goalserve_f1results', 'g_driver_id')

        # Deleting field 'F1Results.g_team_id'
        db.delete_column(u'goalserve_f1results', 'g_team_id')

        # Deleting field 'MatchCommentary.g_driver_id'
        db.delete_column(u'goalserve_matchcommentary', 'g_driver_id')

        # Deleting field 'MatchCommentary.g_team_id'
        db.delete_column(u'goalserve_matchcommentary', 'g_team_id')

        # Deleting field 'Category.g_driver_id'
        db.delete_column(u'goalserve_category', 'g_driver_id')

        # Deleting field 'Category.g_team_id'
        db.delete_column(u'goalserve_category', 'g_team_id')

        # Deleting field 'MatchEvent.g_driver_id'
        db.delete_column(u'goalserve_matchevent', 'g_driver_id')

        # Deleting field 'MatchEvent.g_team_id'
        db.delete_column(u'goalserve_matchevent', 'g_team_id')

        # Deleting field 'Driver.g_driver_id'
        db.delete_column(u'goalserve_driver', 'g_driver_id')

        # Deleting field 'Driver.g_team_id'
        db.delete_column(u'goalserve_driver', 'g_team_id')

        # Deleting field 'MatchStandings.g_driver_id'
        db.delete_column(u'goalserve_matchstandings', 'g_driver_id')

        # Deleting field 'MatchStandings.g_team_id'
        db.delete_column(u'goalserve_matchstandings', 'g_team_id')

        # Deleting field 'F1Race.g_driver_id'
        db.delete_column(u'goalserve_f1race', 'g_driver_id')

        # Deleting field 'F1Race.g_team_id'
        db.delete_column(u'goalserve_f1race', 'g_team_id')

        # Deleting field 'Country.g_driver_id'
        db.delete_column(u'goalserve_country', 'g_driver_id')

        # Deleting field 'Country.g_team_id'
        db.delete_column(u'goalserve_country', 'g_team_id')

        # Deleting field 'F1Team.g_driver_id'
        db.delete_column(u'goalserve_f1team', 'g_driver_id')

        # Deleting field 'F1Team.g_team_id'
        db.delete_column(u'goalserve_f1team', 'g_team_id')

        # Deleting field 'Player.g_driver_id'
        db.delete_column(u'goalserve_player', 'g_driver_id')

        # Deleting field 'Player.g_team_id'
        db.delete_column(u'goalserve_player', 'g_team_id')

        # Deleting field 'Team.g_driver_id'
        db.delete_column(u'goalserve_team', 'g_driver_id')

        # Deleting field 'Team.g_team_id'
        db.delete_column(u'goalserve_team', 'g_team_id')

        # Deleting field 'Stadium.g_driver_id'
        db.delete_column(u'goalserve_stadium', 'g_driver_id')

        # Deleting field 'Stadium.g_team_id'
        db.delete_column(u'goalserve_stadium', 'g_team_id')
