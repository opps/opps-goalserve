...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'F1Team.country'
        db.add_column(u'goalserve_f1team', 'country',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'F1Team.tires'
        db.add_column(u'goalserve_f1team', 'tires',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'F1Team.website'
        db.add_column(u'goalserve_f1team', 'website',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'F1Team.engine'
        db.add_column(u'goalserve_f1team', 'engine',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'F1Team.titles'
        db.add_column(u'goalserve_f1team', 'titles',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'F1Team.launch_date'
        db.add_column(u'goalserve_f1team', 'launch_date',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'F1Team.country'
        db.delete_column(u'goalserve_f1team', 'country')

        # Deleting field 'F1Team.tires'
        db.delete_column(u'goalserve_f1team', 'tires')

        # Deleting field 'F1Team.website'
        db.delete_column(u'goalserve_f1team', 'website')

        # Deleting field 'F1Team.engine'
        db.delete_column(u'goalserve_f1team', 'engine')

        # Deleting field 'F1Team.titles'
        db.delete_column(u'goalserve_f1team', 'titles')

        # Deleting field 'F1Team.launch_date'
        db.delete_column(u'goalserve_f1team', 'launch_date')
