...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'F1Results.pos'
        db.alter_column(u'goalserve_f1results', 'pos', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'F1Results.pos'
        db.alter_column(u'goalserve_f1results', 'pos', self.gf('django.db.models.fields.IntegerField')(default=None))
