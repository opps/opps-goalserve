...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MatchStandings.group'
        db.add_column(u'goalserve_matchstandings', 'group',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MatchStandings.group'
        db.delete_column(u'goalserve_matchstandings', 'group')
