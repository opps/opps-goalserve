...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MatchLineUp.order'
        db.add_column(u'goalserve_matchlineup', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MatchLineUp.order'
        db.delete_column(u'goalserve_matchlineup', 'order')
