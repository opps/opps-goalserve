...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Driver.short_name'
        db.add_column(u'goalserve_driver', 'short_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Driver.birthday'
        db.add_column(u'goalserve_driver', 'birthday',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Driver.birth_city'
        db.add_column(u'goalserve_driver', 'birth_city',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Driver.titles'
        db.add_column(u'goalserve_driver', 'titles',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Driver.past_teams'
        db.add_column(u'goalserve_driver', 'past_teams',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Driver.first_race'
        db.add_column(u'goalserve_driver', 'first_race',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Driver.short_name'
        db.delete_column(u'goalserve_driver', 'short_name')

        # Deleting field 'Driver.birthday'
        db.delete_column(u'goalserve_driver', 'birthday')

        # Deleting field 'Driver.birth_city'
        db.delete_column(u'goalserve_driver', 'birth_city')

        # Deleting field 'Driver.titles'
        db.delete_column(u'goalserve_driver', 'titles')

        # Deleting field 'Driver.past_teams'
        db.delete_column(u'goalserve_driver', 'past_teams')

        # Deleting field 'Driver.first_race'
        db.delete_column(u'goalserve_driver', 'first_race')
