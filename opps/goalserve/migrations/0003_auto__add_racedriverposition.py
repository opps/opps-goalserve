...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RaceDriverPosition'
        db.create_table(u'goalserve_racedriverposition', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('race', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['goalserve.F1Race'])),
            ('table', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('driver', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['goalserve.Driver'])),
            ('position', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'goalserve', ['RaceDriverPosition'])


    def backwards(self, orm):
        # Deleting model 'RaceDriverPosition'
        db.delete_table(u'goalserve_racedriverposition')
