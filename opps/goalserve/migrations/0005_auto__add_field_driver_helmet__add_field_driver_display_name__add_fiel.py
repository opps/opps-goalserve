...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Driver.helmet'
        db.add_column(u'goalserve_driver', 'helmet',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='driver_helmet', null=True, to=orm['images.Image']),
                      keep_default=False)

        # Adding field 'Driver.display_name'
        db.add_column(u'goalserve_driver', 'display_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Driver.country'
        db.add_column(u'goalserve_driver', 'country',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'F1Team.display_name'
        db.add_column(u'goalserve_f1team', 'display_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Driver.helmet'
        db.delete_column(u'goalserve_driver', 'helmet_id')

        # Deleting field 'Driver.display_name'
        db.delete_column(u'goalserve_driver', 'display_name')

        # Deleting field 'Driver.country'
        db.delete_column(u'goalserve_driver', 'country')

        # Deleting field 'F1Team.display_name'
        db.delete_column(u'goalserve_f1team', 'display_name')
